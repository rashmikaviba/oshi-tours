...
exports.ACTIVITY_CATALOG_MAP = exports.TOTAL_AVAILABLE_ACTIVITY_POINTS = exports.ACTIVITY_CATALOG = void 0;
...
exports.TOTAL_AVAILABLE_ACTIVITY_POINTS = exports.ACTIVITY_CATALOG.reduce((acc, cat) => acc + cat.activities.length, 0);
// Map for fast lookup
exports.ACTIVITY_CATALOG_MAP = new Map();
exports.ACTIVITY_CATALOG.forEach((cat) => {
    cat.activities.forEach((act) => {
        exports.ACTIVITY_CATALOG_MAP.set(`${cat.id}::${act.id}`, {
            categoryTitle: cat.title,
            activityName: act.name,
        });
    });
});
//# sourceMappingURL=activityCatalog.js.map