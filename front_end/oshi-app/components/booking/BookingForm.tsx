...
export default function BookingForm({ experienceName }: { experienceName?: string }) {
          ...
          <div className="relative min-h-[400px] mt-10 overflow-hidden">
            <AnimatePresence mode="wait" initial={false}>
              ...
              >
                ...
                {step === 5 && <Step5Additional data={formData} update={updateData} next={nextStep} prev={prevStep} />}
                {step === 6 && (
                  <Step6Review 
                    data={formData} 
                    prev={prevStep} 
