...
export const experiences: Record<string, ExperienceData> = {
  // Primary matching URLs
  "cultural-triangle-5-days": essentialCeylon,
  "sri-lanka-highlights-8-days": ceylonCoastToHighlands,
  "sri-lanka-grand-discovery-11-days": culturalTriangleAndSouth,
  "chauffeur-transport-service": highlandsWildsGoldenSouth,
  "ultimate-sri-lanka-adventure-15-days": grandTour,
